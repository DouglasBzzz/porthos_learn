...
<head>
    ...
    <title>Learn&trade; | Settings</title>
            ...
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    $sqlCarregaDadosDocente = "select distinct d.id, d.nome, d.login, date_format(d.datanascimento,'%d %b %Y') as datanascimento, 
                                            ...
                                            ifnull(d.INSTITUICAO,'Sem instituição informada')as instituicao, d.IDGRAUINSTRUCAO, d.LATTES,
                                            gi.descricao as grauInstrucaoDesc, d.DATANASCIMENTOPUBLICA, d.IDCIDADE, c.descricao as cidDesc,
                                            (select date_format(a.datainclusao,'%d %b %Y') 
                                              from aula as a 
                                             where IDDOCENTE = d.id 
                                            ORDER BY DATAINCLUSAO desc limit 1) as dtUltimoPost, dc.notificacaoaula, dc.notificacaocomentario, dc.notificacaoseguidor, dc.notificacaoavaliacao
                                            from docente as d
                    ...
                    if($resultado){
                        ...
                        <div class="modal-dialog" role="document">
                            ...
                            echo '<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" name="lattes" class="form-control" id="inputLattes" placeholder="Link Lattes" value="'.$dadosDocente['LATTES'].'">
								</div>
							  </div>';
                            /*-----DataNasc-----*/
                            echo '<div class="form-group">
                            ...
                            //recebe notificacoes novas aulas

                            /*if ($dadosDocente['notificacaoaula']=='0'){
                                echo '<div class="checkbox">
									<label>
									  <input type="hidden" name="checkNotificacaoNovaAula" id="checkNotificacaoNovaAula" value="0">  
									  <input type="checkbox" name="checkNotificacaoNovaAula" id="checkNotificacaoNovaAula" value="1"> Receber Notificações de Novas Aulas
									</label>
								  </div>
								</div>';
                            }
                            if ($dadosDocente['notificacaoaula']=='1'){
                                echo '<div class="checkbox">
									<label>
									  <input type="hidden" name="checkNotificacaoNovaAula" id="checkNotificacaoNovaAula" value="0">  
									  <input type="checkbox" name="checkNotificacaoNovaAula" id="checkNotificacaoNovaAula" value="1" checked> Receber Notificações de Novas Aulas
									</label>
								  </div>
								</div>';
                            }*/

                            //recebe notificacoes comentarios
                            if ($dadosDocente['notificacaocomentario']=='0'){
                                echo '<div class="checkbox">
									<label>
									  <input type="hidden" name="checkNotificacaoComentario" id="checkNotificacaoComentario" value="0">  
									  <input type="checkbox" name="checkNotificacaoComentario" id="checkNotificacaoComentario" value="1"> Receber Notificações de Comentários nas suas Aulas
									</label>
								  </div>
								</div>';
                            }
                            if ($dadosDocente['notificacaocomentario']=='1'){
                                echo '<div class="checkbox">
									<label>
									  <input type="hidden" name="checkNotificacaoComentario" id="checkNotificacaoComentario" value="0">  
									  <input type="checkbox" name="checkNotificacaoComentario" id="checkNotificacaoComentario" value="1" checked> Receber Notificações de Comentários nas suas Aulas
									</label>
								  </div>
								</div>';
                            }
                            //recebe notificacao novo seguidor
                            if ($dadosDocente['notificacaoseguidor']=='0'){
                                echo '<div class="checkbox">
									<label>
									  <input type="hidden" name="checkNotificacaoSeguidores" id="checkNotificacaoSeguidores" value="0">  
									  <input type="checkbox" name="checkNotificacaoSeguidores" id="checkNotificacaoSeguidores" value="1"> Receber Notificações de Novos Seguidores
									</label>
								  </div>
								</div>';
                            }
                            if ($dadosDocente['notificacaoseguidor']=='1'){
                                echo '<div class="checkbox">
									<label>
									  <input type="hidden" name="checkNotificacaoSeguidores" id="checkNotificacaoSeguidores" value="0">  
									  <input type="checkbox" name="checkNotificacaoSeguidores" id="checkNotificacaoSeguidores" value="1" checked> Receber Notificações de Novos Seguidores
									</label>
								  </div>
								</div>';
                            }
                            //recebe notificacoes de avaliacoes nas aulas
                            if ($dadosDocente['notificacaoavaliacao']=='0'){
                                echo '<div class="checkbox">
									<label>
									  <input type="hidden" name="checkNotificacaoAvaliacao" id="checkNotificacaoAvaliacao" value="0">  
									  <input type="checkbox" name="checkNotificacaoAvaliacao" id="checkNotificacaoAvaliacao" value="1"> Receber Notificações de Avaliações nas suas Aulas
									</label>
								  </div>
								</div>';
                            }
                            if ($dadosDocente['notificacaoavaliacao']=='1'){
                                echo '<div class="checkbox">
									<label>
									  <input type="hidden" name="checkNotificacaoAvaliacao" id="checkNotificacaoAvaliacao" value="0">  
									  <input type="checkbox" name="checkNotificacaoAvaliacao" id="checkNotificacaoAvaliacao" value="1" checked> Receber Notificações de Avaliações nas suas Aulas
									</label>
								  </div>
								</div>';
                            }
                            //notificacoes novas aulas
                            if ($dadosDocente['notificacaoaula']=='0'){
                                echo '<div class="checkbox">
									<label>
									  <input type="hidden" name="checkNotificacaoNovaAula" id="checkNotificacaoNovaAula" value="0">  
                            ...
                            echo '<div class="form-group">
                                    <h4>Data da última publicação: </h4>';
                            if($dadosDocente['dtUltimoPost']==null){
                                echo '<h4>Você ainda não tem conteúdo publicado</h4>';
                            }else{
                                echo '<h4>'.$dadosDocente['dtUltimoPost'].'</h4>';
                            }
                            echo '</div>';
