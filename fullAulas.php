...
$sqlCarregaDadosDocenteSeguido = "select d.id as idDocenteSeguido, d.nome, d.email, d.cell, date_format(d.datacadastro,'%d %b %Y') as datacadastro, d.resumo,
                                    ...
                                    case
                                        ...
                                        when d.DATANASCIMENTOPUBLICA = 0 then 'Sem data de nascimento informada'
...
<head>
    ...
    <title>Learn&trade; | Visualizar Conteúdos</title>
                ...
                <div class="box-body col-md-4 col-sm-6">
                            ...
                            <div class="back">
                                ...
                                <div class="content">
                                    <div class="main">
                                        ...
                                        <p class="text-center"><?php echo '' . $carregaDadosDocente['resumo'] . ''; ?></p>
                    ...
                    <div class="box-body col-md-8">
                        ...
                        <form action="profile.php" method="post">
                            <button type="submit" class="pull-right btn btn-primary"><i class="fa fa-home"></i> Home
                            </button>
                        </form>
                    </div>
                    <!-- /.box-body -->
