...
<head>
    ...
    <title>Learn&trade; | Recuperar Senha</title>
...
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        <p class="login-box-msg">Insira seu e-email cadastrado para podermos lhe enviar uma senha temporária.</p>

        <form action="recupera_senha_docente.php" method="post" id="formRecupera">
            ...
            <div class="row">
                <div class="captcha_wrapper">
                    <div class="g-recaptcha" data-sitekey="6LfBqC8UAAAAAEn2-s0vCPgm2lsSDU6DPNA3DRvO"></div>
                </div>
                <div class="col-xs-4">
                    <button type="submit" id="btn_envia" class="btn btn-primary btn-block btn-flat">Enviar</button>
                </div>
                <!-- /.col -->
            </div>
        </form>
        <?php
        if ($erro == 1) {
            echo '<font color="#FF0000">Email inválido</font>';
        }
        ?>
        ...
        <a href="login.php">> Lembrou a Senha? Faça Login</a>
