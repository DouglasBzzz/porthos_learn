...
<head>
    ...
    <title>Learn&trade; | Seguidos</title>
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                <i class="fa fa-user-circle"></i>  Seguindo
            </h1>
        </section>
        ...
        <section class="content">
            ...
            <div class="box">
                <div class="box-header with-border">
                    <form action="buscar.php" class="form-group ">
<!--                        <h2 class="box-title">Docentes que você segue:</h2>-->
                        <button type="submit" class="pull-right btn btn-primary"><i class="fa fa-search"></i> Buscar docentes</button>
                    </form>
                </div>
                <div class="box-body">
                    <?php
                    ...
                    $idDocente ->retListaSeguidos($_GET['idDocente']);
                    ?>
                </div>
                <!-- /.box-body -->
